...
/** @defgroup IWDT_FeedDog_Window_INT_Macros INT_Macros
  @{
  */

/**@} end of group IWDT_FeedDog_Window_INT_Macros */

/** @defgroup IWDT_FeedDog_Window_INT_Enumerations INT_Enumerations
  @{
  */

/**@} end of group IWDT_FeedDog_Window_INT_Enumerations */

/** @defgroup IWDT_FeedDog_Window_INT_Structures INT_Structures
  @{
  */

/**@} end of group IWDT_FeedDog_Window_INT_Structures */

/** @defgroup IWDT_FeedDog_Window_INT_Variables INT_Variables
  @{
  */

/**@} end of group IWDT_FeedDog_Window_INT_Variables */

/** @defgroup IWDT_FeedDog_Window_INT_Functions INT_Functions
  @{
  */
