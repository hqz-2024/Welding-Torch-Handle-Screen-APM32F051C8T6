...
/** @defgroup IWDT_FeedDog_System_Macros System_Macros
  @{
  */
...
/**@} end of group IWDT_FeedDog_System_Macros */

/** @defgroup IWDT_FeedDog_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group IWDT_FeedDog_System_Enumerations */

/** @defgroup IWDT_FeedDog_System_Structures System_Structures
  @{
  */

/**@} end of group IWDT_FeedDog_System_Structures */


/** @defgroup IWDT_FeedDog_System_Variables System_Variables
  @{
  */
...
/**@} end of group IWDT_FeedDog_System_Variables */

/** @defgroup IWDT_FeedDog_System_Functions System_Functions
  @{
  */
...
/**@} end of group IWDT_FeedDog_System_Functions */
/**@} end of group IWDT_FeedDog */
/**@} end of group Exsamples */
