...
/** @defgroup DAC_ADC_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group DAC_ADC_System_Enumerations */

/** @defgroup DAC_ADC_System_Structures System_Structures
  @{
  */

/**@} end of group DAC_ADC_System_Structures */
