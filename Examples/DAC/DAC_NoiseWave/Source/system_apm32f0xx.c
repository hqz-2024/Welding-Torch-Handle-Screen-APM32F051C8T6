...
/** @defgroup DAC_NoiseWave_System_Macros System_Macros
  @{
  */
...
/**@} end of group DAC_NoiseWave_System_Macros */

/** @defgroup DAC_NoiseWave_System_Variables System_Variables
  @{
  */
...
/**@} end of group DAC_NoiseWave_System_Variables */

/** @defgroup DAC_NoiseWave_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group DAC_NoiseWave_System_Enumerations */

/** @defgroup DAC_NoiseWave_System_Structures System_Structures
  @{
  */

/**@} end of group DAC_NoiseWave_System_Structures */

/** @defgroup DAC_NoiseWave_System_Functions System_Functions
  @{
  */
...
/**@} end of group DAC_NoiseWave_System_Functions */
