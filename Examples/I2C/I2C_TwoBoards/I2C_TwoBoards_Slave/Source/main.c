...
/** @defgroup I2C_TwoBoards_Slave_Marcos Marcos
  @{
  */
...
/**@} end of group I2C_TwoBoards_Slave_Marcos */

/** @defgroup I2C_TwoBoards_Slave_Enumerations Enumerations
  @{
  */

/**@} end of group I2C_TwoBoards_Slave_Enumerations */

/** @defgroup I2C_TwoBoards_Slave_Structures Structures
  @{
  */

/**@} end of group I2C_TwoBoards_Slave_Structures */

/** @defgroup I2C_TwoBoards_Slave_Variables Variables
  @{
  */

/**@} end of group I2C_TwoBoards_Slave_Variables */
...
void I2CInit(void)
{
    ...
    i2cConfigStruct.timing = 0xB0420F13;  // 100KHz
