...
/** @defgroup GPIO_Toggle_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group GPIO_Toggle_System_Enumerations */

/** @defgroup GPIO_Toggle_System_Structures System_Structures
  @{
  */

/**@} end of group GPIO_Toggle_System_Structures */
