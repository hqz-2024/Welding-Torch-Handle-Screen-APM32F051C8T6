...
/** @defgroup CAN_DualFIFOPolling_Board2_Macros Macros
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_Macros */

/** @defgroup CAN_DualFIFOPolling_Board2_Enumerations Enumerations
  @{
  */

/**@} end of group CAN_DualFIFOPolling_Board2_Enumerations */

/** @defgroup CAN_DualFIFOPolling_Board2_Structures Structures
  @{
  */

/**@} end of group CAN_DualFIFOPolling_Board2_Structures */

/** @defgroup CAN_DualFIFOPolling_Board2_Variables Variables
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_Variables */

/** @defgroup CAN_DualFIFOPolling_Board2_Functions Functions
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_Functions */
