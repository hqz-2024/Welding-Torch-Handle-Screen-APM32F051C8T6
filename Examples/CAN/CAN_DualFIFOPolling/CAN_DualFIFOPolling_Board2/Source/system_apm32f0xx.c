...
/** @addtogroup CAN_DualFIFOPolling_Board2
  @{
  */

/** @defgroup CAN_DualFIFOPolling_Board2_System_Macros System_Macros
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_System_Macros */

/** @defgroup CAN_DualFIFOPolling_Board2_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group CAN_DualFIFOPolling_Board2_System_Enumerations */

/** @defgroup CAN_DualFIFOPolling_Board2_System_Structures System_Structures
  @{
  */

/**@} end of group CAN_DualFIFOPolling_Board2_System_Structures */

/** @defgroup CAN_DualFIFOPolling_Board2_System_Variables System_Variables
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_System_Variables */

/** @defgroup CAN_DualFIFOPolling_Board2_System_Functions System_Functions
  @{
  */
...
/**@} end of group CAN_DualFIFOPolling_Board2_System_Functions */
/**@} end of group CAN_DualFIFOPolling_Board2 */
