...
/** @defgroup TMR_PWMOutput_System_Macros System_Macros
  @{
*/
...
/**@} end of group TMR_PWMOutput_System_Macros */

/** @defgroup TMR_PWMOutput_System_Enumerations System_Enumerations
  @{
*/

/**@} end of group TMR_PWMOutput_System_Enumerations */

/** @defgroup TMR_PWMOutput_System_Structures System_Structures
  @{
*/

/**@} end of group TMR_PWMOutput_System_Structures */

/** @defgroup TMR_PWMOutput_System_Variables System_Variables
  @{
*/
...
/**@} end of group TMR_PWMOutput_System_Variables */

/** @defgroup TMR_PWMOutput_System_Functions System_Functions
  @{
*/
...
/**@} end of group TMR_PWMOutput_System_Functions */
