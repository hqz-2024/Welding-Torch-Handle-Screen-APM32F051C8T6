...
/** @addtogroup TMR_SynchronizationWithTMR1
  @{
*/

/** @defgroup TMR_SynchronizationWithTMR1_System_Macros System_Macros
  @{
*/
...
/**@} end of group TMR_SynchronizationWithTMR1_System_Macros */

/** @defgroup TMR_SynchronizationWithTMR1_System_Enumerations System_Enumerations
  @{
*/

/**@} end of group TMR_SynchronizationWithTMR1_System_Enumerations */

/** @defgroup TMR_SynchronizationWithTMR1_System_Structures System_Structures
  @{
*/

/**@} end of group TMR_SynchronizationWithTMR1_System_Structures */

/** @defgroup TMR_SynchronizationWithTMR1_System_Variables System_Variables
  @{
*/
...
/**@} end of group TMR_SynchronizationWithTMR1_System_Variables */

/** @defgroup TMR_SynchronizationWithTMR1_System_Functions System_Functions
  @{
*/
...
{
    uint32_t sysClock, pllMull, pllSource, plldiv, Prescaler;
...
/**@} end of group TMR_SynchronizationWithTMR1_System_Functions */
/**@} end of group TMR_SynchronizationWithTMR1 */
