...
After the program is downloaded, please reset the motherboard and then reset the slave.
Press the master key1,When compare buffer is the same, the Board slave LED2 is on.
...
&par Directory contents
  ...
  - I2S/I2S_TwoBoards/master/Source/apm32f0xx_int.c         Master Interrupt handlers
  - I2S/I2S_TwoBoards/master/Source/main.c                  Master Main program
  - I2S/I2S_TwoBoards/slave/Source/apm32f0xx_int.c          Slave  Interrupt handlers
  - I2S/I2S_TwoBoards/slave/Source/main.c                   Slave  Main program
