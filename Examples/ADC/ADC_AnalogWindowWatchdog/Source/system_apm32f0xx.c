...
/** @defgroup ADC_AnalogWindowWatchdog_System_Macros System_Macros
  @{
  */
...
/**@} end of group ADC_AnalogWindowWatchdog_System_Macros */

/** @defgroup ADC_AnalogWindowWatchdog_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group ADC_AnalogWindowWatchdog_System_Enumerations */

/** @defgroup ADC_AnalogWindowWatchdog_System_Structures System_Structures
  @{
  */

/**@} end of group ADC_AnalogWindowWatchdog_System_Structures */

/** @defgroup ADC_AnalogWindowWatchdog_System_Variables System_Variables
  @{
  */
...
/**@} end of group ADC_AnalogWindowWatchdog_System_Variables */

/** @defgroup ADC_AnalogWindowWatchdog_System_Functions System_Functions
  @{
  */
...
void SystemInit(void)
{
    ...
    /* Configure the Vector Table location in Internal SRAM or FLASH */
#ifdef VECT_TAB_SRAM
...
/**@} end of group ADC_AnalogWindowWatchdog_System_Functions */
