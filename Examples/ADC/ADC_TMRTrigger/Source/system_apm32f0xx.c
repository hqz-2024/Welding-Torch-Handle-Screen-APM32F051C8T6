...
/** @defgroup ADC_TMRTrigger_System_Enumerations System_Enumerations
  @{
  */

/**@} end of group ADC_TMRTrigger_System_Enumerations */

/** @defgroup ADC_TMRTrigger_System_Structures System_Structures
  @{
  */

/**@} end of group ADC_TMRTrigger_System_Structures */
