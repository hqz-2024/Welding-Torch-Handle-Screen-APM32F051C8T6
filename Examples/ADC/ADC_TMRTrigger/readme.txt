...
This example describes how to use the ADC1 to convert continuously
the voltage applied to ADC1_Channel0 input.
...
&par Directory contents
  ...
  - ADC/ADC_TMRTrigger/Source/apm32f0xx_int.c     Interrupt handlers
  - ADC/ADC_TMRTrigger/Source/main.c              Main program
