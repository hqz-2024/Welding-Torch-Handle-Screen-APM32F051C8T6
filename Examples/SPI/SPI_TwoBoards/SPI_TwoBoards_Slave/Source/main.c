...
/** @defgroup SPI_TwoBoards_Slave_Macros Macros
  @{
*/
...
/**@} end of group SPI_TwoBoards_Slave_Macros */

/** @defgroup SPI_TwoBoards_Slave_Enumerations Enumerations
  @{
*/

/**@} end of group SPI_TwoBoards_Slave_Enumerations */

/** @defgroup SPI_TwoBoards_Slave_Structures Structures
  @{
*/

/**@} end of group SPI_TwoBoards_Slave_Structures */

/** @defgroup SPI_TwoBoards_Slave_Variables Variables
  @{
*/
...
/**@} end of group SPI_TwoBoards_Slave_Variables */

/** @defgroup SPI_TwoBoards_Slave_Functions Functions
  @{
  */
...
void APM_MINI_SPIInit(void)
{
    ...
    /* Set Clock polarity is High, but Master is Low */
    ...
    /* SPI Clock Phase is 2EDGE, but Master is 1EDGE */
...
/**@} end of group SPI_TwoBoards_Slave_Functions */
