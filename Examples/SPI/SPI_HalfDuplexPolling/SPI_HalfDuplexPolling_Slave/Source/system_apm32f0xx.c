...
/** @defgroup SPI_HalfDuplexPolling_Slave_System_Macros System_Macros
  @{
*/
...
/**@} end of group SPI_HalfDuplexPolling_Slave_System_Macros */

/** @defgroup SPI_HalfDuplexPolling_Slave_System_Variables System_Variables
  @{
*/
...
/**@} end of group SPI_HalfDuplexPolling_Slave_System_Variables */

/** @defgroup SPI_HalfDuplexPolling_Slave_System_Functions System_Functions
  @{
*/
...
/**@} end of group SPI_HalfDuplexPolling_Slave_System_Functions */
